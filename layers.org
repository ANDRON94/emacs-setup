...
#+end_src
*** Modal editing
1. [[https://github.com/justbur/emacs-bind-map][Bind]] personal keymaps in multiple locations.
2. [[https://github.com/emacs-evil/evil][the Extensible VI Layer]] for Emacs.
#+begin_src emacs-lisp :tangle yes
...
(use-package lsp-mode
  ...
  (bind-map-for-mode-inherit my-lsp-mode-map my-leader-map
    :minor-modes (lsp-mode)
    :bindings ("g p" 'xref-pop-marker-stack
